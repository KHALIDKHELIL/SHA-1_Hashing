...
public class SHA1HashGUI {
    ...
    private void initialize() {
        ...
        JButton calculateButton = createButton("Hash", e -> {
        ...
        darkModeCheckBox.setFont(new Font("Arial", Font.BOLD, 14));// This line sets the font for the "Dark Mode" text only
        ...
        resultPanel.setLayout(new BorderLayout(5, 5));// Sets BorderLayout with 5-pixel gaps
        resultPanel.setBorder(new EmptyBorder(10, 10, 10, 10));// Adds 10-pixel padding on all sides
